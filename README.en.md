...
### 🚀 Projects & Focus
Now I focus on these projects.

- **Game Dev:** [The Alice's adventure of nightmare](https://store.steampowered.com/app/3493230/_/) (Steam) dev
- **Low-level:** Making physics engine / Nand to Tetris
- **Web Dev:** No framework web / developing club activitiy's sns
- **Academic:** studying Materials Informatics.

### 🏆 Awards & Achievements
- **Excellence Award** - 1-Monthon (2024)
- **Month award** - Game Creater Kousien 2024
- **Honorable Mention** - Invention Award for Children by JIII (2015)
...
> I want to make the wonderful product by using Materials Informatics.
